                    ...
                    <div className="col-4">
                        <div className="row">
                            <div className="d-flex justify-content-center align-items-center bgProfilePicture ">
                                <img src={profilbild} alt="Profilbild" className="rotate w-75 h-75 profilePicture mb-3" ref={imgRef} />
                            </div>
                        </div>
                        <div className="row">
                        ...
                        <div className="row">
                            <div className="d-flex justify-content-center bgProfilePicture pb-5">
                                <div className="divBorder align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-github linkedInColor me-1 mb-2" viewBox="0 0 16 16">
